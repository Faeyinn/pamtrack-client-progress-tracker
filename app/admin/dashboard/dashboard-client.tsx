  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 pb-24 md:pb-12 space-y-10 relative z-10">
        ...
        <div className="relative" data-aos="fade-up">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground leading-none font-[family:var(--font-display)]">
        ...
        <div 
          className="rounded-[2rem] shadow-2xl shadow-foreground/5 bg-card/80 backdrop-blur-xl border border-border/60 relative overflow-hidden"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          ...
          <div className="relative z-10 p-6 sm:p-10 space-y-10">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3 px-1">
                ...
                <h2 className="text-base font-semibold tracking-tight text-foreground font-[family:var(--font-display)]">
                  Statistik Utama
                </h2>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 pt-4">
              ...
              <div className="lg:col-span-2 space-y-10">
                {/* Analytics Chart */}
                <section className="space-y-6">
                  <AnalyticsSection projects={projects} isLoading={isLoading} />
                </section>
